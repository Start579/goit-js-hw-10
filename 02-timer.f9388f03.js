...
const timer = {
    start () {
        const interval = setInterval(()=>{
            ...
            if (days == "00" && hours == "00" && minutes == "00" && seconds == "00") clearInterval(interval);
        }, 1000);
    },
    convertMs (ms) {
        const second = 1000;
...
(0, _flatpickrDefault.default)("#datetime-picker", {
    ...
    onClose (selectedDates) {
        let date = new Date();
        if (selectedDates[0].getTime() <= date.getTime()) (0, _notiflixNotifyAio.Notify).failure("Wrong Date", {
            position: "right-top",
            backOverlay: true,
            clickToClose: true,
            closeButton: true
            ...
            (0, _notiflixNotifyAio.Notify).success("Timer on", {
                position: "right-top",
                backOverlay: true,
                clickToClose: true,
                closeButton: true
